...
private:
	...
	bool _twoHanded, _blockBothHands, _fixedWeapon, _fixedWeaponShow, _isConsumable, _isFireExtinguisher, _isHandsFree;
...
public:
	...
	/// Can this item be used without being held in a hand?
	bool isHandsFree() const;
